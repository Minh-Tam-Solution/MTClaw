...
func DefaultMenuCommands() []telego.BotCommand {
	return []telego.BotCommand{
		...
		{Command: "spec", Description: "Generate a structured specification"},
		{Command: "spec_list", Description: "List recent specifications"},
		{Command: "spec_detail", Description: "View specification detail by ID"},
