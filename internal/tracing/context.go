...
const (
	traceIDKey              contextKey = "mtclaw_trace_id"
	parentSpanKey           contextKey = "mtclaw_parent_span_id"
	collectorKey            contextKey = "mtclaw_trace_collector"
	announceParentKey       contextKey = "mtclaw_announce_parent_span_id"
	delegateParentTraceKey  contextKey = "mtclaw_delegate_parent_trace_id"
)
